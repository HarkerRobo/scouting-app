...
module.exports = {
    ...
    "js-module": {
        ...
        uninstall: function (jsModule, www_dir, plugin_id) {
            var pluginRelativePath = path.join(
                "plugins",
                plugin_id,
                jsModule.src
            );
    ...
    "header-file": {
        install: function (obj, plugin_dir, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "header-fileinstall is not supported for browser"
            );
        },
        uninstall: function (obj, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "header-file.uninstall is not supported for browser"
            );
        }
    },
    "resource-file": {
        install: function (obj, plugin_dir, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "resource-file.install is not supported for browser"
            );
        },
        uninstall: function (obj, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "resource-file.uninstall is not supported for browser"
            );
        }
    },
    framework: {
        install: function (obj, plugin_dir, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "framework.install is not supported for browser"
            );
        },
        uninstall: function (obj, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "framework.uninstall is not supported for browser"
            );
        }
    },
    "lib-file": {
        install: function (obj, plugin_dir, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "lib-file.install is not supported for browser"
            );
        },
        uninstall: function (obj, project_dir, plugin_id, options) {
            events.emit(
                "verbose",
                "lib-file.uninstall is not supported for browser"
            );
        }
    },
    asset: {
